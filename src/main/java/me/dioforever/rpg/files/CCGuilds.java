...
public class CCGuilds {
    ...
    public static void setup(){
        ...
        fileLists = new File(Bukkit.getServer().getPluginManager().getPlugin("RPG").getDataFolder(), "guilds.yml");
    ...
    public static void save(){
        try {
            ...
            System.out.println("Couldn´t save your file (guilds.yml)");
        }
